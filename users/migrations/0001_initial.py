    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to=users.utils._create_path_media_user, verbose_name='Изображение')),
                ('date_of_birth', models.DateField(verbose_name='Дата рождения')),
                ('phone_number', models.CharField(blank=True, max_length=17, unique=True, validators=[users.utils._phone_validation], verbose_name='Телефонный номер')),
